...
export interface ApiAmbiguedadAmbiguedad extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    correcciones: Schema.Attribute.Relation<
      'oneToMany',
    ...
    explicacion: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCorreccionCorreccion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    esAceptada: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      ...
      Schema.Attribute.DefaultTo<false>;
    esModificada: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      ...
      Schema.Attribute.DefaultTo<false>;
    idAmbiguedad: Schema.Attribute.Relation<
      'manyToOne',
      'api::ambiguedad.ambiguedad'
    >;
    locale: Schema.Attribute.String;
...
export interface ApiProyectoProyecto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    esActivo: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiRequisitoRequisito extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ambiguedad: Schema.Attribute.Relation<
      'oneToOne',
      'api::ambiguedad.ambiguedad'
    >;
    creadoPor: Schema.Attribute.Email &
    ...
    esVersionActiva: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<true>;
    idVersionado: Schema.Attribute.Relation<
      'manyToOne',
      'api::version-requisito.version-requisito'
    >;
    locale: Schema.Attribute.String;
...
export interface ApiVersionRequisitoVersionRequisito
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::version-requisito.version-requisito'
    >;
    numeroID: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ambiguedad.ambiguedad': ApiAmbiguedadAmbiguedad;
      'api::correccion.correccion': ApiCorreccionCorreccion;
